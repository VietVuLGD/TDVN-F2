...
import { BrandProvider } from "@/components/site/brand";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: company.assets.ogImage },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: company.assets.ogImage },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          sameAs: Array.isArray(company.socials)
            ? company.socials.map((s: { href: string }) => s.href)
            : [],
        }),
      },
    ],
